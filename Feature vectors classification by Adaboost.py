...
def load_data(feature_list):
    ...
    # 读取csv文件中的特定列并指定数据类型   # 目前最佳特征组合1:['Vc', 'Height', 'Area','Gave', 'Sticking_Expansion','Fourier']
                                                     # 2:['Sticking_Expansion', 'Height', 'Area', 'Edgenum', 'Gave', 'Fourier']
...
features = ['Height', 'Area', 'Gave', 'Fourier', 'Sticking_Expansion', 'Edgenum']
feature_list = ['Vx', 'Vy', 'Vc', 'Height', 'Width', 'Area','Gave','Fourier','Sticking_Expansion','Edgenum']
features_test = ['Vx', 'Vc', 'Height', 'Width', 'Area', 'Gave', 'Fourier', 'Sticking_Expansion']
with open("最佳特征选择-Adaboost(去掉Edgenum).csv",'a') as f:
    # f.write("特征个数")
    # f.write(",")
    # f.write("G_mean_max")
    # f.write("\n")
    ...
    ########################################################################################################################
                ...
                # n_estimators = [20,50,100,200,300,500,800,1000]

                validation_list = []
                for ratio in np.arange(1, 101):
                    evaluate_score = 0
                    for fold in range(k):
                        # 训练集和验证集划分
...
# 最佳G-mean分数为: 0.9221388919541469
# 最佳特征组合为: ['Height', 'Area', 'Gave', 'Fourier', 'Sticking_Expansion', 'Edgenum']
